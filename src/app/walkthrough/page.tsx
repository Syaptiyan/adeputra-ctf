...
const walkthroughs: WalkthroughItem[] = [
  {
    ...
    difficulty: 'easy',
    points: 50,
    flag: String.fromCharCode(65,80,67,84,70,123,104,51,108,108,48,95,119,48,114,108,100,95,49,95,52,109,95,104,52,99,107,51,114,125),
  ...
  },
  {
    ...
    difficulty: 'easy',
    points: 100,
    flag: String.fromCharCode(65,80,67,84,70,123,99,48,48,107,49,51,95,49,110,115,112,101,107,116,48,114,95,102,48,117,110,100,95,49,116,125),
...
base64.b64decode("QVBDVEZ7YzAwa2szX2kzc3BlazByX2YwdW5kXzF0fQ==").decode()`,
  ...
  },
  {
    ...
    difficulty: 'easy',
    points: 100,
    flag: String.fromCharCode(65,80,67,84,70,123,52,115,99,49,49,95,52,114,116,95,112,52,112,51,114,95,112,108,52,110,51,125),
...
# Online: https://www.rapidtables.com/convert/number/ascii-to-text.html`,
  ...
  },
  {
    ...
    difficulty: 'easy',
    points: 150,
    flag: String.fromCharCode(65,80,67,84,70,123,109,51,116,52,100,52,116,52,95,106,51,106,52,107,95,100,49,103,49,116,52,108,125),
...
# Camera  : iPhone 14`,
  ...
  },
  {
    ...
    difficulty: 'medium',
    points: 200,
    flag: String.fromCharCode(65,80,67,84,70,123,120,48,114,95,114,52,104,52,115,49,52,95,52,103,51,110,125),
...
# Input → From Hex → XOR (key: X) → Output`,
  ...
  },
  {
    ...
    difficulty: 'medium',
    points: 200,
    flag: String.fromCharCode(65,80,67,84,70,123,104,49,100,100,51,110,95,112,48,114,116,52,108,95,52,100,109,49,110,125),
...
curl https://target.com/robots.txt`,
  ...
  },
  {
    ...
    difficulty: 'medium',
    points: 200,
    flag: String.fromCharCode(65,80,67,84,70,123,108,49,107,51,95,98,108,49,110,100,95,112,51,114,115,48,110,95,115,51,51,115,125),
...
# Online: https://dcode.fr/caesar-cipher`,
  ...
  },
  {
    ...
    difficulty: 'medium',
    points: 200,
    flag: String.fromCharCode(65,80,67,84,70,123,48,115,49,110,116,95,103,104,48,115,116,95,102,48,117,110,100,125),
...
# "name": "John Doe"`,
  ...
  },
  {
    ...
    difficulty: 'medium',
    points: 250,
    flag: String.fromCharCode(65,80,67,84,70,123,114,52,99,51,95,99,48,110,100,49,116,49,48,110,95,119,49,110,110,51,114,125),
...
# 5. Start attack`,
  ...
  },
  {
    ...
    difficulty: 'medium',
    points: 250,
    flag: String.fromCharCode(65,80,67,84,70,123,116,49,109,51,95,109,52,99,104,49,110,51,95,114,51,118,51,114,115,51,100,125),
...
print(code.co_consts)`,
  ...
  },
  {
    ...
    difficulty: 'hard',
    points: 300,
    flag: String.fromCharCode(65,80,67,84,70,123,106,119,116,95,110,48,110,51,95,52,108,103,48,95,98,121,112,52,115,115,51,100,125),
...
# 5. Copy JWT baru`,
  ...
  },
  {
    ...
    difficulty: 'hard',
    points: 300,
    flag: String.fromCharCode(65,80,67,84,70,123,98,49,110,52,114,121,95,102,49,108,51,95,51,120,116,114,52,99,116,51,100,125),
...
dd if=secret.bin bs=1 skip=OFFSET of=extracted.bin`,
  ...
  },
  {
    ...
    difficulty: 'hard',
    points: 300,
    flag: String.fromCharCode(65,80,67,84,70,123,115,109,52,108,108,95,107,51,121,95,98,49,103,95,112,114,48,98,108,51,109,125),
...
# http://factordb.com/index.php?query=3233`,
  ...
  },
  {
    ...
    difficulty: 'hard',
    points: 350,
    flag: String.fromCharCode(65,80,67,84,70,123,98,108,49,110,100,95,115,113,108,49,95,49,115,95,112,52,49,110,102,117,108,125),
