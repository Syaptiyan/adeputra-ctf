    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-2xl shadow-black/50">
          ...
          <p className="text-gray-400 mb-6">Join and start solving challenges</p>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1.5">Letters, numbers, and underscores only. 3-20 characters.</p>
            </div>
