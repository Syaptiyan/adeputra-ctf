...
export default function Register() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (authError) {
      if (authError.message.includes('already registered')) {
        setError('Email ini sudah terdaftar. Coba masuk sebagai gantinya.')
      } else {
  ...
  const getPasswordStrengthText = () => {
    ...
    if (passwordStrength <= 2) return 'Cukup'
    if (passwordStrength <= 3) return 'Bagus'
    return 'Kuat'
  }
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-2xl shadow-black/50">
          ...
          <p className="text-gray-400 mb-6">Bergabung dan mulai menyelesaikan tantangan</p>
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-800 font-semibold py-3 px-4 rounded-xl transition-all duration-200 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 bg-gray-800 hover:bg-gray-750 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 border border-gray-700 hover:border-gray-600 disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gray-900 text-gray-500">atau daftar dengan email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1.5">Huruf, angka, dan underscore saja. 3-20 karakter.</p>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-gray-800/50 border rounded-xl pl-10 pr-12 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 transition-all duration-200 ${
            ...
            <button
              ...
              className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-4 rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-orange-500/25"
            >
              {loading ? (
                <>
